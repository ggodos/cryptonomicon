...
// TODO:
// [S]OLID
// 1. [x] Наличие в состоянии ЗАВИСИМЫХ ДАННЫХ | Критичность: 5+
// 2. [x] Запросы напрямую внутри компонента (???) | Критичность: 5
// 3. [x] При удалении остается подписка на загрузку тикера | Критичность: 5
// 4. [x] Количество запросов | Критичность: 4
// 5. [ ] Хендл нескольких вкладок (Broadcast channgegl api| localStorage) | Критичность: 4
// 6. [ ] Обработка ошибок API | Критичность: 4
// 7. [x] Валидация тикеров | Критичность: 4
// 8. [x] При удалении тикера не удаляется в localStorage| Критичность: 4
// 9. [x] Одинаковый код в watch | Критичность: 3
// 10.[ ] localStorage и анонимные вкладки | Критичность: 3
// 11.[ ] График ужасно выглядит если будет много цен | Критичность: 2
// 12.[ ] Магические строки и числа (URL, 5000 милиисекунд задержки, ключ локал стораджа, количество на странице)| Критичность: 1

// Параллельно
// [x] График сломан если везде одинаковые значения.
// [x] При удалении тикера остаётся выбор
// [x] Если не удалять данные то они не сохраняются в localStorage
